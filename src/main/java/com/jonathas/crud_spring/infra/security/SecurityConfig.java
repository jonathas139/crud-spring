...
public class SecurityConfig {
    ...
    public UrlBasedCorsConfigurationSource corsConfigurationSource() {
        ...
        corsConfiguration.addAllowedOrigin("http://localhost:4200"); // Permite a origem do frontend
        ...
        corsConfiguration.setAllowCredentials(true); // Permite credenciais (cookies, tokens)
